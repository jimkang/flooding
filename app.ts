...
async function followRoute({
  ...
  parts = [
    ...
    {
      // sample: '2_D-PB.wav',
      sample: 'ak-trumpet-d-1.wav',
      loop: true,
      loopStartSeconds: 0,
      loopEndSeconds: 3.853,
      adjustLoopForRate: true,
      transposeProportion: 0.25,
      transposeFreqFactor: 0.125,
      pan: -0.2,
      ampFactor: 2,
    ...
    {
      sample: 'ak-cello-d3-2.wav',
      // sample: '2_D-PB-fade-out.wav',
      impulse: 'echoey-impulse.wav', // Covers up the thumping at certain pitches.
      loop: true,
      loopStartSeconds: 0,
      loopEndSeconds: 3.715,
      adjustLoopForRate: true,
